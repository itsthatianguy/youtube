...
class GameOver(BaseState):
    ...
    def startup(self, persistent):
        ...
        self.final_score = self.font.render(f"Your final score was {score} points", True, pygame.Color("Red"))
        final_score_center = (self.screen_rect.center[0], self.screen_rect.center[1] +  50)
    ...
    def draw(self, surface):
        ...
        surface.blit(self.final_score, self.final_score_rect)
